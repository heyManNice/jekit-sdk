    ...
    return (
        <section className="page-section">
            <div className="flex items-end max-md:items-stretch gap-8 max-md:flex-col max-md:gap-5">
                        ...
                        <HelpTooltip
                            ...
                            content={
                                <div className="space-y-1.5">
                                    <p><span className="text-accent">查询方式</span>：在搜索框输入 URL 后按回车即可查询。需要包含http部分。</p>
                                    <p><span className="text-chart-secondary">页面指标</span>：页面的指标是你当前查询的 URL 的路径所对应的路径的指标</p>
                                    <p><span className="text-accent">为什么不直接罗列我的域名的所有子页面？</span>：出于隐私安全考虑，jekit-sdk 不会上报域名的路径名，所以后端不知道你的域名有哪些子页面。</p>
                                </div>
                            }
                        />
                    </h1>
                ...
                {/* 数据起始日期 */}
                <GlowCard className="surface-card overflow-hidden px-4 py-2 max-md:hidden">
                    ...
                    <div className="mt-2 flex items-center gap-1.5 text-xs text-text-secondary">
                        ...
                        <HelpTooltip
                            ...
                            content={
                                <div className="space-y-1.5">
                                    <p><span className="text-chart-secondary">子页面数量限制</span>：目的是防止服务器资源被无限耗尽。如果当前配置不足够使用，你可以添加 <Link className="underline" to="/docs/intro/what-this-is/">交流群</Link> 免费提高限制。</p>
                                </div>
                            }
                        />
                    </div>
