...
import { GITHUB_REPO, GITHUB_REPO_SLUG } from "@/config/site";
...
function Github() {
    ...
    return (
        <div className="md:w-40 flex justify-end items-center">
            <a href={GITHUB_REPO} aria-label="开源 收藏量" target="_blank" className="flex items-center cursor-pointer gap-2 md:border border-primary/20 self-center px-2 py-1 rounded">
